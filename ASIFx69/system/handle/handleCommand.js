module.exports = function({ api, models, Users, Threads, Currencies }) {
  ...
  return async function({ event }) {
    ...
    const { allowInbox, adminOnly, keyAdminOnly } = global.ASIFx69.configs.ASIFx69;
    const { PREFIX, ADMINBOT, developermode, OPERATOR, approval } = global.ASIFx69;
